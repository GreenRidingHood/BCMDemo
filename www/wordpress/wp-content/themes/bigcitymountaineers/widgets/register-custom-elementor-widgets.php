...
class ElementorCustomElement {
	...
	public function init(){
		add_action( 'elementor/widgets/widgets_registered', array( $this, 'register_this_widget' ) );
	}

	public function register_this_widget() {
		...
		if(defined('ELEMENTOR_PATH') && class_exists('Elementor\Widget_Base')){
			...
			$widget_file = 'widgets/elementor-widgets/my-first-widget.php';
				...
				if ( is_callable( 'Elementor\Plugin', 'instance' ) ) {
					...
					if ( isset( $elementor->widgets_manager ) ) {
						if ( method_exists( $elementor->widgets_manager, 'register_widget_type' ) ) {
							...
							if ( $template_file && is_readable( $template_file ) ) {
								require_once $template_file;
								Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Elementor\Widget_My_Custom_Elementor_Thingy() );
